...
class GetInscriptionRequest extends SaloonRequest
{
    ...
    {
        return "/api/inscriptions/{$this->id}";
    }

    protected function castToDto(SaloonResponse $response): Inscription
    {
        return Inscription::fromSaloonResponse($response);
    }
}
