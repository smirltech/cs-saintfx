...
class OuvrageCategoryPolicy
{
    ...
    {
        return $user->can('ouvrage-categories.view.*')
            ? Response::allow()
    ...
    {
        return $user->can('ouvrage-categories.view.' . $category->id)
            ? Response::allow()
    ...
    {
       return  $user->can('ouvrage-categories.create')
            ? Response::allow()
    ...
    {
        return $user->can('ouvrage-categories.update.' . $category->id)
            ? Response::allow()
    ...
    {
        return $user->can('ouvrage-categories.delete.' . $category->id)
            ? Response::allow()
