                                ...
                                <div class="mt-3">
                                    @if(Gate::allows(RolePermission::create_user->name) AND auth()->user()->id != $user->id)
                                        <form method="post" class="center"
                                              action="{{route('scolarite.users.destroy',$user)}}">
                                            @csrf @method('DELETE')
                    ...
                    <div class="card mb-5">
                        <div class="card-body">
                            @if(Gate::allows(RolePermission::create_user->name) || auth()->user()->id == $user->id)
                                <form action="{{route('scolarite.users.update',$user)}}" enctype="multipart/form-data"
                                      method="POST"
                                    ...
                                    @if ($user->hasVerifiedEmail())
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{ route('scolarite.users.password.autoreset',$user) }}"
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{route('scolarite.users.index')}}" class="btn btn-outline-primary btn-sm">
