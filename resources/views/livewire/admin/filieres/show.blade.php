                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Option : </b> <span class="float-right">  <a href="/admin/options/{{ $filiere->option->id }}">{{ $filiere->option->nom }}</a></span>
                                </li>
                                <li class="list-group-item">
                                    <b>Section : </b> <span class="float-right">  <a href="/admin/sections/{{ $filiere->option->section->id }}">{{ $filiere->option->section->nom }}</a></span>
                                </li>
                            </ul>
                            <div class="mt-4">
