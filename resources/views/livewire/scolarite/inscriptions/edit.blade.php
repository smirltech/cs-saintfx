                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <input placeholder="Saisir le postnom" type="text"
                                       wire:model="etudiant.postnom"
                                       class="form-control  @error('etudiant.postnom') is-invalid @enderror">
                                @error('etudiant.postnom')
                                <span class="text-red">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="">Prenom</label>
                                <input placeholder="Saisir le prenom" type="text" wire:model="etudiant.prenom"
                                       class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                ...
                                <select wire:model="etudiant.sexe"
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                ...
                                <select wire:model="etudiant.etat_civil" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-4">
                                ...
                                <select wire:model="admission.promotion_id"
                        ...
                        @if($admission->promotion_id > 0)
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6 col-lg-4">
                                    ...
                                    <select wire:model="admission.promotion2_id"
                                            class="form-control">
                                        <option value="-1">Choisir la promotion...</option>
